...
if totScore < 14:
   print "you are likely to be well"

elif (totScore >= 14) and (totScore < 17):
    print "you are likely to have a mild depression"

elif (totScore >= 17) and (totScore < 21):
    print "you are likely to have moderate depression"

else:
    print "you are likely to have a severe depression"
    print "do you want to consult any therapist regarding your situation [Yes or No]\n"
    x = raw_input()
    if x == "Y" or x == "y":
        pass
